...
class MealTableViewController: UITableViewController {
    ...
    private func loadSampleMeals(){
        ...
        guard let meal1 = Meal(name: "Pandan Waffle!", photo: photo1, rating: 4) else {
            fatalError("Unable to instantiate meal1")
        }
         
        guard let meal2 = Meal(name: "Chai Tea with the gals", photo: photo2, rating: 5) else {
            fatalError("Unable to instantiate meal2")
        }
         
        guard let meal3 = Meal(name: "Ube Waffle :D", photo: photo3, rating: 4) else {
